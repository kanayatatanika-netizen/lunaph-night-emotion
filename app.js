...
const resultViewCopy = {
  ...
  fear: {
    ...
    light: [
      ...
      "シャンパンで場内が湧いてるのに、心の中ではずっと地雷処理班をしている。",
    ],
    deep: [
      "場内が少し静かになっただけで『今日の私、干され確定？』まで脳内で判決が出る。",
      "返信が短い、目線が違う、笑が一個少ない。それだけで謝罪文と改善案が完成する。",
      "卓では笑顔なのに、内側だけ警報レベルMAXでずっと避難訓練している。",
    ],
    support: "大丈夫。空気を読みすぎる君は弱いんじゃない。ちゃんと場を見てきたから、不安まで先に拾ってしまうだけ。その警戒心ごと、ちゃんと君を守っているよ。",
  },
  solitude: {
    emotion: "孤独",
    partner: "くれす",
    light: [
      ...
      "他の卓が盛り上がるほど、店内にいるのに自分だけ透明人間になる。",
    ],
    deep: [
      "お茶じゃないのに心がお茶。隣に人がいても、内側だけぼっち卓。",
      "『今日も楽しかった』って言われても、私の中身までは誰も見てない気がする。",
      "場内で必要とされてるはずなのに、急に『役としての私だけ』が残ってしんどい。",
    ],
    support: "大丈夫。接客でたくさん話したあとに寂しくなるのは、おかしくない。明るくしていた時間のぶん、夜に本音が戻ってきただけ。その夜のそばには、ちゃんと居場所があるよ。",
  },
  freedom: {
    emotion: "自由",
    partner: "みちる",
    ...
    support: "大丈夫。誰か用の自分を脱ぎたくなる夜があっても、それは冷たいわけじゃない。ちゃんと合わせてきたぶん、君自身に戻る時間が必要なだけ。出口はちゃんとあるよ。",
  },
  regret: {
    emotion: "後悔",
    partner: "くゆり",
    ...
    deep: [
      ...
      "『もっと可愛く返せた』が呪文化して、脳内で同じページをめくり続ける。",
    ],
    support: "大丈夫。終わった会話を何度も思い出す君は、だめな人じゃない。言葉を大切にしているから、あとから直したくなるだけ。その夜のそばには、ちゃんと味方がいるよ。",
  },
};
...
questions.splice(0, questions.length, ...[
  ...
  {
    scene: "SCENE 05 / シャンパンを入れてもらえた。店内の空気が少し変わる。",
    text: "シャンパンをもらった瞬間、近い本音は？",
    answers: [
      ["リアクション薄くなかった？ちゃんと喜べてた？って焦る", "fear", ""],
      ["嬉しいのに、周りが盛り上がるほど自分だけ少し遠くなる", "solitude", ""],
      ["もっと可愛く驚けたし、もっと上手くお礼できた気がする", "regret", ""],
      ["素直に嬉しい。大切にされてる感じがして少し泣きそう", "affection", ""],
    ],
  },
  {
    scene: "SCENE 06 / 隣の卓がかなり盛り上がっている。自分の席にも笑顔はある。",
    text: "隣の卓が大盛り上がりの時、心の中は？",
    answers: [
