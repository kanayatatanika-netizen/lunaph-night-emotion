...
questions.splice(0, questions.length, ...[
  ...
  {
    scene: "SCENE 08 / 卓にいる間も、通知とお礼DMが溜まっていく。",
    text: "卓中に通知が溜まっている時、どうする？",
    answers: [
      ["目の前の卓を優先しつつ、あとで返す相手を覚えておく", "fear", ""],
      ["スマホは見ずに、今話している相手に集中する", "solitude", ""],
      ["返せるタイミングだけ返して、無理に全部追わない", "freedom", ""],
      ["お礼DMで失礼がないように、送る順番を決めておく", "regret", ""],
    ],
  },
  {
