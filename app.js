...
const resultViewCopy = {
  affection: {
    ...
    partner: "めろあ",
    light: [
      "人に優しくしたあと、少しだけ見返りを期待してしまう。",
      "大切にした相手の反応で、その日の気分がわりと変わる。",
      "仕事として笑っていたはずなのに、気持ちまで置いて帰れない。",
    ],
    deep: [
      "優しくした相手の反応が薄いだけで、脳内で反省会と失恋会見が同時開催される。",
      "大切にされたい気持ちが強すぎて、返信ひとつで生活リズムまで持っていかれる。",
      "誰かのために笑っていたはずが、気づいたら自分の心まで勤務延長している。",
    ],
    support: "大丈夫。人を大切にしすぎる夜があっても、それは重さだけじゃない。ちゃんと向き合った証拠だから、君の愛情を全部なかったことにしなくていい。",
  },
  fear: {
    emotion: "恐怖",
    partner: "ふろむ",
    light: [
      "相手の反応が少し薄いだけで、何か間違えたかもと考える。",
      "その場では笑えても、帰り道で急に不安の答え合わせを始める。",
      "何も起きていないのに、念のため最悪パターンを用意している。",
    ],
    deep: [
      "一瞬の沈黙だけで、嫌われた・怒らせた・もう終わったをフルセットで想像する。",
      "まだ何も起きていないのに、脳内では謝罪文と改善案まで完成している。",
      "ちゃんと笑えていた日でも、帰宅後の頭の中だけずっと非常ベルが鳴っている。",
    ],
    support: "大丈夫。怖がりな君は弱いんじゃない。人の空気をちゃんと見てきたから、不安まで先に拾ってしまうだけ。ふろむは、君を守ろうとして現れている。",
  },
  solitude: {
    emotion: "孤独",
    partner: "くれす",
    light: [
      "たくさん話した日の帰り道ほど、急にひとりを感じる。",
      "通知はあるのに、今ほしい言葉だけが来ない気がする。",
      "人前で明るくしていた日の夜ほど、部屋の静けさが濃くなる。",
    ],
    deep: [
      "さっきまで人と笑っていたのに、家に着いた瞬間『結局ひとり』が刺さる。",
      "スマホを開いて閉じてまた開く。通知はあるのに、欲しい人からだけ来ない夜。",
      "寂しいと言ったら負けな気がして、平気なふりのまま布団で静かに沈む。",
    ],
    support: "大丈夫。人と笑ったあとに寂しくなるのは、おかしくない。昼にちゃんと明るくいられたぶん、夜に本音が戻ってきただけ。くれすは、その夜のそばにいる。",
  },
  freedom: {
    emotion: "自由",
    partner: "みちる",
    light: [
      "求められる自分を演じたあと、急に全部脱ぎたくなる。",
      "予定や返信が詰まると、自分が薄くなっていく感じがする。",
      "ちゃんとしている日ほど、帰り道でどこか遠くへ行きたくなる。",
    ],
    deep: [
      "人に合わせるのが上手すぎて、自分の本体がどこかにログアウトしている。",
      "『ちゃんとしなきゃ』をやりすぎて、帰宅後に予定も通知も全部捨てたくなる。",
      "自由になりたいのに、急に時間が空くと何をしたいのか分からなくなる。",
    ],
    support: "大丈夫。逃げたくなる夜があっても、それは投げ出したいだけじゃない。誰か用の自分から、君自身に戻りたい合図。みちるは出口を照らしている。",
  },
  regret: {
    emotion: "後悔",
    partner: "くゆり",
    ...
    support: "大丈夫。引きずる君は、ただ弱いんじゃない。言葉を雑に扱えないだけ。くゆりは、終わった時間まで大切に抱えてしまう君のそばにいる。",
  },
};
...
const supportMessages = {
  affection: {
    ...
    line: "大丈夫。人に優しくしたあと、少しだけ見返りを欲しくなる夜があってもいい。ちゃんと大切にしたから、心まで置いて帰れなかっただけ。君の愛情は、悪者じゃないよ。",
  },
  fear: {
    title: "しおんから、恐怖を抱えているあなたへ",
    line: "大丈夫。反応を読みすぎる夜があっても、それは弱さじゃない。人と向き合ってきたぶん、空気の変化に気づきすぎるだけ。ふろむは、その警戒心ごと君を守っているよ。",
  },
  solitude: {
    title: "しおんから、孤独を抱えているあなたへ",
    line: "大丈夫。人と笑ったあとに寂しくなる夜があっても、それはわがままじゃない。明るくしていた時間のぶん、帰ってから本音が戻ってきただけ。そんな君でも、ちゃんとここにいていいよ。",
  },
  freedom: {
...
questions.splice(0, questions.length, ...[
  {
    scene: "SCENE 01 / 人前で笑ったあと。駅まで歩きながら、スマホを開く。",
    text: "人と笑った帰り道、最初に残るものは？",
    answers: [
      ["相手の反応を思い出して、変じゃなかったか確認したくなる", "fear", ""],
      ["さっきまで賑やかだったぶん、急に静けさが来る", "solitude", ""],
      ["今日の返しを思い返して、もっと良い言い方を探す", "regret", ""],
      ["誰か用の自分から、早く抜け出したくなる", "freedom", ""],
    ],
  },
  {
    scene: "SCENE 02 / 家に着いた。鍵を閉めて、やっと素の顔に戻る。",
    text: "玄関に入った瞬間、いちばん近いのは？",
    answers: [
      ["スマホを見て、返すべきものがないか確認する", "fear", ""],
      ["部屋の静かさにほっとするのに、少し寂しくもなる", "solitude", ""],
      ["カバンを置いた瞬間、今日の会話が戻ってくる", "regret", ""],
      ["服もメイクも気分も、外用の自分を早く脱ぎたい", "freedom", ""],
    ],
  },
  {
    scene: "SCENE 03 / 夜ごはん前。コンビニ袋を置いて、少しだけ無になる。",
    text: "夕食前、ついやってしまうことは？",
    answers: [
      ["明日の予定や連絡を見て、先に安心材料を探す", "fear", ""],
      ["動画や音楽を流して、部屋を静かすぎないようにする", "solitude", ""],
      ["今日の言葉や態度で気になるところを思い出す", "regret", ""],
      ["食べたいものくらいは、誰にも合わせず決める", "freedom", ""],
    ],
  },
  {
    scene: "SCENE 04 / お風呂。シャワーの音で、やっと外の音が消える。",
    text: "シャワー中、ふっと戻ってくるのは？",
    answers: [
      ["誰かの表情が少し曇った気がした場面", "fear", ""],
      ["誰にも見せない顔になった時の、急な静けさ", "solitude", ""],
      ["あの時こう返せばよかった、という会話の続き", "regret", ""],
      ["今日あったことを、大切な人に聞いてほしい気持ち", "affection", ""],
    ],
  },
  {
    scene: "SCENE 05 / ベッドの上。スマホだけが暗い部屋で光っている。",
    text: "寝る前、つい確認してしまうものは？",
    answers: [
      ["通知や返信。何もないと分かっていても見てしまう", "fear", ""],
      ["SNSの流れ。誰かの気配だけ少し欲しくなる", "solitude", ""],
      ["今日送った文章。変な言い方じゃなかったか見る", "regret", ""],
      ["大切な人の投稿や写真。少しだけ安心したくなる", "affection", ""],
    ],
  },
  {
    scene: "SCENE 06 / 電気を消す前。明日の予定を見てしまう。",
    text: "明日の自分を想像した時、近いのは？",
    answers: [
      ["またちゃんとできるか、先に不安になる", "fear", ""],
      ["明日は少しだけ、人と距離を置きたいと思う", "solitude", ""],
      ["今日のやり残しを、明日どう直すか考える", "regret", ""],
      ["予定を少し空けて、自分だけの時間を作りたくなる", "freedom", ""],
    ],
  },
  {
    ...
    answers: [
      ["『今日、大丈夫だった？』と確認したいけど重そうで消す", "fear", ""],
      ["『帰ったら急に寂しくなった』と言いたいけど消す", "solitude", ""],
      ["『さっきの言い方ごめん』を送るか迷って消す", "regret", ""],
      ["『もっと話したかった』を送るか迷って消す", "affection", ""],
    ],
  },
  {
  ...
  },
  {
    ...
    text: "人と笑ったあと、今夜いちばん残った感情は？",
    answers: [
      ["相手の反応を考えて、不安が残る夜だった", "fear", ""],
      ["人といた後の静けさが残る夜だった", "solitude", ""],
      ["終わった会話を何度も思い出す夜だった", "regret", ""],
...
function renderResult(key) {
  ...
  elements.resultDefinition.textContent = `人と笑ったあと、あなたに残った感情は「${view.emotion}」でした。`;
...
function shareOnX() {
  ...
  const activeScenes = resultDepth === "deep" ? view.deep : view.light;
  const text = `人と笑ったあと、私に残った感情は「${view.emotion}」でした。\nパートナーは${view.partner}。\n${activeScenes[0]}\n\n#LUNAPH #夜に残る感情診断`;
...
function drawShareImage() {
  ...
  context.fillText("人と笑ったあと、夜に残る感情が姿を持つ。", 92, 308);
  ...
  context.fillText("#LUNAPH  #夜に残る感情診断", 92, 1220);
  return canvas;
}
